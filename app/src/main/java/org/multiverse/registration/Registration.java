...
import org.tord.neuroncore.registrationerror.InvalidEmailError;
import org.tord.neuroncore.registrationerror.InvalidLengthError;
import org.tord.neuroncore.registrationerror.PasswordsDontMatchError;
    ...
    public void setupRegisterButton(final Button registerButton, final Activity currentActivity, final Class targetActivityClass, final FirebaseAuth fbAuth) {
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseNetworking.checkForEmailAndUsernameClashesAndSendToDatabase(registeredUser, currentActivity, targetActivityClass);
